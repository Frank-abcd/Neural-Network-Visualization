...
void PropertyPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->parametersUpdated((*reinterpret_cast< std::add_pointer_t<QMap<QString,QString>>>(_a[1]))); break;
        case 1: _t->onUpdateButtonClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PropertyPanel::*)(const QMap<QString,QString> & )>(_a, &PropertyPanel::parametersUpdated, 0))
            return;
    }
}
...
// SIGNAL 0
void PropertyPanel::parametersUpdated(const QMap<QString,QString> & _t1)
{
